...
const en = {
  ...
  hosts: {
    ...
    buildWheel: 'Build Package',
    triggerUpdate: 'Trigger Update',
    buildSuccess: 'Build successful',
    buildFailed: 'Build failed',
    triggerSuccess: 'Update triggered',
    triggerFailed: 'Failed to trigger update',
    agentNotConnected: 'Agent not connected via WebSocket',
    updating: 'Updating...',
  ...
  databases: {
    ...
    targetConfigTitle: 'Monitor Target Config',
    runtimeMetricsTitle: 'Runtime Metrics',
    addTarget: 'Add Database Target',
    editTarget: 'Edit Database Target',
    deleteTargetConfirm: 'Disable this database target?',
    targetHost: 'Host',
    name: 'Database Name',
    type: 'Type',
    host: 'Host',
    ...
    collectInterval: 'Collect Interval (s)',
  ...
  suppressionRules: {
    ...
    description: 'Manage alert suppression rules for hosts, services, and alert rules',
    resourceType: 'Resource Type',
    resourceTypeHost: 'Host',
    resourceTypeService: 'Service',
    resourceTypeAlertRule: 'Alert Rule',
    resourceTypeLogKeyword: 'Log Keyword',
    ...
    suppressAiAnalysis: 'Suppress AI Analysis',
    suppressLogScan: 'Suppress Log Scan',
    reason: 'Reason',
    createdBy: 'Created By',
    isActive: 'Active',
    matchCount: 'Match Count',
    quickSuppress: 'Quick Suppress',
    quickSuppressSuccess: 'Suppression rule created',
    quickSuppressFailed: 'Failed to create suppression rule',
    deleteSuccess: 'Deleted successfully',
    deleteFailed: 'Failed to delete',
    updateSuccess: 'Updated successfully',
    updateFailed: 'Failed to update',
    confirmDelete: 'Confirm to delete this suppression rule?',
    noRules: 'No suppression rules',
    createRule: 'Create Suppression Rule',
    editRule: 'Edit Suppression Rule',
    duration: 'Duration',
    durationHours: 'hours',
    permanent: 'Permanent',
    ...
    rulesForService: 'Suppression rules for this service',
    rulesForHost: 'Suppression rules for this host',
    // Quick suppress modal
    quickSuppressModalTitle: 'Suppress Alerts',
    quickSuppressModalDescription: 'After suppression, no alert notifications will be sent for this resource',
    reasonPlaceholder: 'Enter reason (optional)',
    confirm: 'Confirm',
    cancel: 'Cancel',
    ignoreService: 'Ignore this service',
